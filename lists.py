...
def long_words(words):
    ...
    If no words are longer than 4 characters, return an empty list::
        ...
        []
    """
    word_4char = [ word for word in words if len(word) > 4]
...
def n_long_words(words, n):
    ...
    word_n_length = [word for word in words if len(word) > n]

    return word_n_length
...
def halvesies(numbers):
    ...
    the half::
        ...
        [0.5, 2.5]
    """
    half_number = [(num/2) for num in numbers ]
    return half_number
...
def average(numbers):
    ...
    try:
        ...
        average_of_num = sum_of_num / len(numbers)
...
def join_strings_with_comma(words):
    ...
    for word in words:
        combo_string = combo_string + word
